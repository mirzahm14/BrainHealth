        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="#">Riwayat Konsultasi</a></li>
                </ul>
                </li>
            </ul>
            <ul class="d-flex">
                <a class="profile" style="padding-top: 7px;" href="#">
        ...
        <form class="shadow-lg p-3 mb-5 bg-body rounded" action="" method="post">
            <fieldset>
                ...
                <p>
                    ...
                    <input type="number" class="form-control" id="nomor_hp" placeholder="08XX XXXX XXXX">
                </p>
            </fieldset>
