                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="pemesanan.php" class="btn btn-outline-warning">Konsultasi</a>
                                </div>
                                </div>
                        </div>
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Kamu dapat berdiskusi terkait permasalahanmu dengan solusi yang diberikan oleh ahlinya.</p>
                                    <a href="pemesanan.php" class="btn btn-outline-warning">Konsultasi</a>
                                </div>
                                </div>
                        </div>
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Tenang saja semua akan membaik seiring berjalannya waktu tentunya dengan dukungan dari ahli.</p>
                                    <a href="pemesanan.php" class="btn btn-outline-warning">Konsultasi</a>
                                </div>
                                </div>    
                        </div>
